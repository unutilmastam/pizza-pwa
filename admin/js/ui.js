/**
 * Admin interfeys komponentlari: element yasash, toast, modal, skeleton.
 * Bu yerda biznes-mantiq yo'q — faqat DOM.
 *
 * Mijoz ilovasidagi `js/ui.js` dan alohida: u bottom-sheet va haptic
 * kabi mobil narsalarga qurilgan, admin esa desktop dialoglar bilan
 * ishlaydi. `el()` yordamchisi bir xil shaklda qoldirilgan.
 */
