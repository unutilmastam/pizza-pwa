...
const DICT = {
  uz: {
    ...
    'order.cancelSoon': 'Bekor qilish Node servis ulangach ishlaydi (6-bosqich)',
    'order.rateFood': 'Taom',
  ...
  ru: {
    ...
    'order.cancelSoon': 'Отмена заработает после подключения Node-сервиса (6-й этап)',
    'order.rateFood': 'Еда',
  ...
  en: {
    ...
    'order.cancelSoon': 'Cancelling works once the Node service is connected (stage 6)',
    'order.rateFood': 'Food',
